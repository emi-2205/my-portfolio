...
export const NavBar = () => {
  ...
  const [scrolled, setScrolled] = useState(true); //originally at false
  ...
  useEffect(() => {
    const onScroll = () => {
      if (window.scrollY > 50) {
        ...
        setScrolled(true); //originally at false
      }
    }
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a target="_blank" href="http://www.linkedin.com/in/emilio-joseph-grieco-8b0a53138/"><img src={navIcon1} alt="" /></a>
